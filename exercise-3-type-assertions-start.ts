...
const population = getPopulation() as number; //because we do know we're expecting a number type value returned

// Now you've added a type assertion, there's a type error in the code below.
// Remove the code that is incorrect.

console.log(population); // we cannot apply toUpperCase method on a number type value
